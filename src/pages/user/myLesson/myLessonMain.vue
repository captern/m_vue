<template>
    <div class="vote-item-page" v-wechat-title="$route.meta.title='课程详情'">
        ...
        <div class="vote-item-area">
            ...
            <div class="btns-area">
                ...
                <div v-if="lessonData.type == '1'">
                    ...
                    <router-link v-else-if="lessonData.test_id"
                                 :to="'/testFail/' + lessonData.test_id + '/' + lessonId">
                ...
                <div v-if="lessonData.check_but == 'start'" class="vote-btn" @click="registerCheckBtnEnter('1')">上课签到
                </div>
                <div v-else-if="lessonData.check_but == 'end'" class="vote-btn" @click="registerCheckBtnEnter('2')">
                    下课签到
                </div>
        ...
        <!--签到或者亲啊退的入口-->
        <alert-tip v-if="registerEnter" @closeTip="registerEnter = !registerEnter" @confirmTip="registerCheckBtn"
                   tipType="three"
